...
:menu
	...
	echo "                                                                             " 
	echo "~~~~~~~~~~~~~~~~~~~~~Written by: Aarush Aitha (Stolen from Ethan Fowler)~~~~~~~~~~~~~~~~~~~~~~"
	echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
:disGueAdm
	...
	if %errorlevel%==1 (
		net user guest Cyb3rP@tri0t! /active:no
	)
	...
	if %errorlevel%==1 (
		net user administrator Cyb3rP@tri0t! /active:no
		pause
		goto :menu
	)
